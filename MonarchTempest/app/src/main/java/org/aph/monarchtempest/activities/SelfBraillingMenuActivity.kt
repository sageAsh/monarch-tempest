...
class SelfBraillingMenuActivity: AbstractMenuActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setTitle(org.aph.monarchtempest.R.string.self_brailling_widget_menu_title)
    }
     ...
     */
    override fun getTitleId() = org.aph.monarchtempest.R.string.self_brailling_widget_menu_title
    ...
    private fun inflateSettingItemLayout(): AccessibleListView {
        return findViewById<AccessibleListView>(R.id.settings_listview).apply {
            ...
            setNext(makeAccessibleItem(org.aph.monarchtempest.R.string.show_image_example))
            setNext(makeAccessibleItem(org.aph.monarchtempest.R.string.braille_and_image_example))
            setNext(makeAccessibleItem(org.aph.monarchtempest.R.string.scrolling_braille_image_example))
            setNext(makeAccessibleItem(org.aph.monarchtempest.R.string.scrolling_braille_only_example))
            setNext(makeAccessibleItem(org.aph.monarchtempest.R.string.grid_movement_example))

            setOnItemClickListener { _, _, position, _ ->
                val targetActivity = when (position) {
                    0 -> SelfBraillingActivity::class.java
                    1 -> null
                    2 -> null
                    3 -> null
                    4 -> null
                ...
                if(targetActivity != null) {
                    startActivity(Intent(this@SelfBraillingMenuActivity, targetActivity))
                }
            }
        }
    }
